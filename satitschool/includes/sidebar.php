...
<nav class="sidebar">
    <div class="sidebar-header d-flex align-items-center justify-content-center py-4">
        <img src="favicon.png" alt="Logo" class="me-3 shadow-sm rounded bg-white p-1"
    ...
    <ul class="list-unstyled components">
        ...
        <?php if ($is_admin): ?>
            ...
            <li>
                <a href="#basicDataSubmenu" data-bs-toggle="collapse" aria-expanded="<?= $is_basic ? 'true' : 'false' ?>"
                    class="dropdown-toggle <?= $is_basic ? '' : 'collapsed' ?>">
                    <i class="fas fa-database fa-fw me-2"></i> ข้อมูลพื้นฐาน
                </a>
                <ul class="collapse list-unstyled <?= $is_basic ? 'show' : '' ?>" id="basicDataSubmenu">
                    <li class="<?= ($current_page == 'teachers.php') ? 'active' : '' ?>"><a href="teachers.php"><i
                                class="fas fa-chalkboard-teacher fa-fw me-2"></i> ข้อมูลครู</a></li>
                    <li class="<?= ($current_page == 'students.php') ? 'active' : '' ?>"><a href="students.php"><i
                                class="fas fa-user-graduate fa-fw me-2"></i> ข้อมูลนักเรียน</a></li>
                    <li class="<?= ($current_page == 'subjects.php') ? 'active' : '' ?>"><a href="subjects.php"><i
                                class="fas fa-book fa-fw me-2"></i> ข้อมูลวิชา</a></li>
                    <li class="<?= ($current_page == 'classrooms.php') ? 'active' : '' ?>"><a href="classrooms.php"><i
                                class="fas fa-door-open fa-fw me-2"></i> ข้อมูลชั้นและห้อง</a></li>
                </ul>
            </li>
        <?php endif; ?>
        ...
        <?php if ($is_admin || $is_teacher): ?>
            ...
            <li class="<?= ($current_page == 'schedules.php') ? 'active' : '' ?>">
                <a href="schedules.php"><i class="fas fa-calendar-alt fa-fw me-2"></i>
                    <?= $is_teacher ? 'ตารางสอนของฉัน' : 'จัดการตารางเรียน' ?></a>
            </li>
        ...
        <?php if ($is_admin): ?>
            <li>
                ...
                <ul class="collapse list-unstyled" id="settingsSubmenu">
                    <li><a href="rbac.php" class="<?= ($current_page == 'rbac.php') ? 'active' : '' ?>"><i
                                class="fas fa-users-cog fa-fw me-2"></i> จัดการสิทธิ์ (RBAC)</a></li>
                </ul>
            </li>
        <?php endif; ?>
    </ul>
    ...
    <nav class="navbar navbar-expand-lg navbar-custom">
        <div class="container-fluid">
            ...
            <div class="d-flex ms-auto align-items-center">
                <div class="dropdown">
                    <button
                        class="btn btn-light dropdown-toggle d-flex align-items-center bg-transparent border-0 shadow-none text-dark"
                        type="button" id="profileDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                        <?php if (!empty($_SESSION['profile_picture'])): ?>
                            <img src="<?php echo htmlspecialchars($_SESSION['profile_picture']); ?>"
                                class="rounded-circle me-2 border border-secondary" width="35" height="35"
                    ...
                    <ul class="dropdown-menu dropdown-menu-end shadow border-0" aria-labelledby="profileDropdown">
                        <li><a class="dropdown-item py-2" href="#" data-bs-toggle="modal"
                                data-bs-target="#userProfileModal"><i class="fas fa-user-cog me-2 text-primary"></i>
                                บัญชีและการตั้งค่า</a></li>
                        <li>
                            <hr class="dropdown-divider">
                        </li>
                        <li><a class="dropdown-item py-2 text-danger fw-bold" href="logout.php"><i
