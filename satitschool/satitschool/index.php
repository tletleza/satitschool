<?php 
/**
 * ไฟล์ index.php: หน้า Dashboard หลักของระบบ
 * แสดงข้อมูลสถิติ กราฟ และข่าวสารประกาศ โดยมีการแบ่งสิทธิ์การมองเห็นตาม Role
 */
require_once 'includes/check_auth.php'; // ตรวจสอบการเข้าสู่ระบบ
require_once 'includes/check_role.php'; // เตรียมฟังก์ชันตรวจสอบสิทธิ์
?>
...
<div class="container-fluid mt-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <!-- แสดงสถานะการซิงค์ข้อมูลอัตโนมัติ -->
